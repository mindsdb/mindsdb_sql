    ...
    def test_join_predictor_plan_aliases(self):
        ...
        expected_plan = QueryPlan(
            steps=[
                ...
                ApplyPredictorStep(namespace='mindsdb', dataframe=Result(0), alias=Identifier('tb'), predictor='pred'),
                JoinStep(left=Result(0), right=Result(1),
    ...
    def test_join_predictor_plan_predictor_alias(self):
        ...
        expected_plan = QueryPlan(
            steps=[
                ...
                ApplyPredictorStep(namespace='mindsdb', predictor='pred', alias=Identifier('pred_alias'), dataframe=Result(0)),
                JoinStep(left=Result(0), right=Result(1),
                         query=Join(left=Identifier('result_0', alias=Identifier('tab1')),
